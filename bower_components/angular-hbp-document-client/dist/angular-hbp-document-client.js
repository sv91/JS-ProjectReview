...
.service('hbpEntityStore', ['$http', '$q', 'bbpConfig', 'hbpUtil', 'hbpIdentityUserDirectory', 'hbpDocumentClientResolveUserIds', 'hbpErrorService', function($http, $q, bbpConfig, hbpUtil, hbpIdentityUserDirectory, hbpDocumentClientResolveUserIds, hbpErrorService) {
    'use strict';
